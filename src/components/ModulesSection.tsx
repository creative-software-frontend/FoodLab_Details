...
const ModulesSection = () => {
  const modules = [
    ...
    { title: 'Customer App', icon: <HiOutlineSwitchHorizontal />, desc: 'Food Order & Tracking' },
    { title: 'Vendor App', icon: <HiOutlineUserGroup />, desc: 'Food create & Order manage system' },
